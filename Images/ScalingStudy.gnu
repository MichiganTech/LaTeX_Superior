# ScalingStudy.gnu
#
# Gnuplot instructions for plotting the data in ScalingStudy.dat
#
# Usage:
# gnuplot ScalingStudy.gnu

set terminal postscript landscape enhanced color dashed 15
set output "ScalingStudy.eps"
...
# Plot the data
plot "ScalingStudy.dat" using 1:($2) ti "NPROC = 1" with linesp lt 3 pt 6, \
     "ScalingStudy.dat" using 1:($3) ti "NPROC = 2" with linesp lt 4 pt 4, \
     "ScalingStudy.dat" using 1:($4) ti "NPROC = 4" with linesp lt 1 pt 2
